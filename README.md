...
APIは3回しか叩かないようにしてあるので、無料枠でも十分動きます。

使用する際は、ローカル環境とAPIを用意してください。
...
間接リンク構造を作成することで、分野間のページの移動がしやすくなります。
...
OSSとして、contributionを受け入れます。改善案があればissueを立ててください。  
作業はforkして、PRでお願いします。  
ゆるくやっていくので気軽にお願いします。
